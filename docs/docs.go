    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.SetKeyRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid provider — must be gemini, openai, or anthropic",
                        "schema": {
                            "$ref": "#/definitions/api.ErrorResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.KeyDeletedResponse"
                        }
                    },
                    "400": {
        ...
        "/api/v1/chat": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Thread ID (from POST /api/v1/threads)",
                        "name": "thread_id",
                        "in": "query",
                        "required": true
                    },
                ...
                "responses": {
                    ...
                    "502": {
                        "description": "Rhizome unavailable",
                        "schema": {
                            "$ref": "#/definitions/api.ErrorResponse"
                        }
                    }
        ...
        "/api/v1/chat/resume": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Thread ID and resolution value",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.ResumeRequestBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/incidents/{id}/treatment": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "thread_id required",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/notifications/stream": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "SSE stream of typed events (alert, interaction_pending, job_started/job_step/job_complete/job_failed, heartbeat)",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/v1/projects/{id}/tasks/generate": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/api.CreateThreadRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/threads/{id}/session-context": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.SessionContextView"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Partial session context override",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.UpdateSessionContextRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "api.ChatRequest": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "example": "What should I do in my garden today?"
                }
            }
        },
        "api.ChatResponse": {
            ...
            "properties": {
                ...
                "response": {
                    "type": "string",
                    "example": "Based on your garden profile..."
                },
                "thread_id": {
                    "type": "string",
                    "example": "silver-fern-cascade"
                }
            }
        },
        ...
        "api.SessionContextObjectRef": {
            "type": "object",
            "properties": {
                "label": {
                    "type": "string",
                    "example": "Cherry Tomato (Sungold)"
                },
                "subject_id": {
                    "type": "string",
                    "example": "plant-uuid"
        ...
        "api.SessionContextView": {
            ...
            "properties": {
                "energy_text": {
                    "type": "string",
                    "example": "low, focused, tired but can water"
                },
                "focus_context": {
                    "type": "array",
                    "items": {
                ...
                "focus_text": {
                    "type": "string",
                    "example": "How do I fertilize the cherry tomatoes?"
                },
                "source": {
                    "type": "string",
                    "enum": [
                ...
                "time_text": {
                    "type": "string",
                    "example": "45 minutes, all afternoon"
                },
                "updated_at": {
                    "type": "string",
        ...
        "api.UpdateSessionContextRequest": {
            "type": "object",
            "properties": {
                "energy_text": {
                    "type": "string",
